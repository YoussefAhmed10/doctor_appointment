...
mixin _$LoginState<T> {
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(_LoignInitial<T> value) loginInitial,
  ...
  TResult? mapOrNull<TResult extends Object?>({
    TResult? Function(_LoignInitial<T> value)? loginInitial,
...
/// @nodoc
abstract class _$$LoignInitialImplCopyWith<T, $Res> {
  factory _$$LoignInitialImplCopyWith(_$LoignInitialImpl<T> value,
          $Res Function(_$LoignInitialImpl<T>) then) =
      __$$LoignInitialImplCopyWithImpl<T, $Res>;
}

/// @nodoc
class __$$LoignInitialImplCopyWithImpl<T, $Res>
    extends _$LoginStateCopyWithImpl<T, $Res, _$LoignInitialImpl<T>>
    implements _$$LoignInitialImplCopyWith<T, $Res> {
  __$$LoignInitialImplCopyWithImpl(
      _$LoignInitialImpl<T> _value, $Res Function(_$LoignInitialImpl<T>) _then)
      : super(_value, _then);
}

/// @nodoc

class _$LoignInitialImpl<T> implements _LoignInitial<T> {
  const _$LoignInitialImpl();
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$LoignInitialImpl<T>);
  }
...
abstract class _LoignInitial<T> implements LoginState<T> {
  const factory _LoignInitial() = _$LoignInitialImpl<T>;
}
